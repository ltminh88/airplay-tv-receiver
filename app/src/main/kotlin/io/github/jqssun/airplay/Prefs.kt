...
object Prefs {
    ...
    // Default OFF: NTP-scheduled releaseOutputBuffer timestamps are unreliable on low-end
    // Amlogic/MediaTek decoders (Android 9 / API<30) and cause visible frame flicker. Immediate
    // render (releaseOutputBuffer(idx, true)) is the robust default; scheduling stays available as
    // an advanced opt-in for SoCs that honor render-at-timestamp.
